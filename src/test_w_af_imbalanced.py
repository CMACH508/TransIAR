...
idx_af_nouse = pickle.load(open('../dataset/dataset_af_noused.pkl','rb'))
af_test_nouse = idx_af_nouse['chara_nouse']
af_test_nouse = torch.tensor(af_test_nouse, dtype=torch.float)
print(af_test_nouse.shape)

af_test = torch.cat((af_test, af_test_nouse))
